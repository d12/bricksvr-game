...
namespace UnityEngine.XR.Interaction.Toolkit
{
	...
	public class XRDirectInteractor : XRBaseControllerInteractor
	{
        ...
        public void RemoveInteractableFromTargets(XRBaseInteractable interactable)
        {
            if (interactable && m_ValidTargets.Contains(interactable))
                m_ValidTargets.Remove(interactable);
        }
        ...
        public override void GetValidTargets(List<XRBaseInteractable> validTargets)
		{
            ...
            m_ValidTargets.RemoveAll(t => t == null);
            // m_ValidTargets.RemoveAll(t => t.GetDistanceSqrToInteractor(this) > 0.5f);
